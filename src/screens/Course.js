  ...
  return (
    <Background>
      <ScrollView className="flex flex-col m-5 gap-y-6" showsVerticalScrollIndicator={false}>
        <Text className="w-full pt-5 -mb-3 text-lg font-semibold text-center text-darkblue">Courses</Text>

        {/* course list */}
        <View className="flex flex-col w-full gap-y-3">

          {/* cyber */}
          <TouchableOpacity className="flex flex-row justify-around px-1 py-3 rounded-lg bg-darkblue" onPress={() => navigation.navigate('detail-course')}>
