  ...
  return (
    <Background useBackround={true}>
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* header */}
        <View
          className="absolute w-screen bg-darkblue"
          style={{ height: 338 }}
        />
        <View className="mx-3 my-5">
          <View className="flex flex-col items-center  mb-5 gap-y-4">
            ...
            <View className="flex flex-row items-center justify-around w-80 py-1 bg-white rounded-lg">
          ...
          <View className="flex flex-col gap-y-2">
            <View className="flex flex-col gap-y-2">
              <View className="flex flex-row items-center justify-between">
                <View className="flex flex-row items-center gap-x-2">
                  <Text className="bg-[#3B88C3] text-white py-0.5 px-1 rounded-md font-bold">
                    1
                  </Text>
